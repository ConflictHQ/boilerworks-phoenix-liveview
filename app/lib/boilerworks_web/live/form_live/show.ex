  ...
  def render(assigns) do
    ...
    <div class="mt-8 space-y-8">
      ...
      <div>
        ...
        <div class="space-y-2">
          <div :for={field <- @fields} class="flex items-center gap-4 rounded-lg bg-zinc-800 border border-zinc-700 px-4 py-3">
      ...
      <div>
        ...
        <.table id="submissions" rows={@submissions}>
          ...
          <:col :let={sub} label="Submitted By"><%= if sub.submitted_by, do: sub.submitted_by.email, else: "-" %></:col>
